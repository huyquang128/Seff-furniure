    ...
    return (
        <ul
            className="max-w-[1440px] mx-auto max-xl:px-[68px] 
                            max-lg:px-3 flex justify-between  py-1
                            gap-3  cursor-pointer "
        >
            {allMenuNav?.map((item) => (
                <div key={item._id} className="">
                    <li
                        className="text-white py-2.5 text-sm"
                    ...
                    >
                        ...
                        {openNavmenuLv2 === item._id && (
                            <motion.div
                                ...
                                className="absolute right-0 left-0 top-[45px]  bg-white shadow-xl"
                                onMouseEnter={() => setOpenNavmenuLv2(item.id)}
                                onMouseLeave={() => setOpenNavmenuLv2(null)}
                            >
                                {/* child menu */}
                                <div className="grid grid-cols-5 w-[1440px] mx-auto ">
